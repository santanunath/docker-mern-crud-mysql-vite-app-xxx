...
const ConnectDB = async () => {
  ...
  // ---------------------
  // 'async' 'await' query 
  // which creates the database if it doesn't exist
  // -------------------
  await pool.query(
  ...
  // -------------------
  // async await query 
  // which changes to the pool's database 
  ...
  // ------------------
  // async await query 
  // which creates the 'users' table 
  // if it doesn't exist and creates table for id, name, email
  // ------------------
