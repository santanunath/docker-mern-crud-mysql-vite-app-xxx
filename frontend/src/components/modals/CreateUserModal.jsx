/*
 ...
 which will add users to the database and 
 we will be using this as a functional component for table
*/
...
/*
 ...
 which takes a argument inside for adding the user 
 to the user aray for dynamic display witout any reload
*/
...
/*
  ...
  which first checks if all the inputs are filled, 
  sends a post request to the server using axios 
  then shows a toast message if is successful or not
*/
