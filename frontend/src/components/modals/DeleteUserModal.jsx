...
which will delete users from the database 
and we will be using this as a functional component for table
*/
...
/*
 creation of an async await function which first checks 
 if the input is filled, sends a DELETE request to the server 
 using axios then shows a toast message if is successful or not
*/
